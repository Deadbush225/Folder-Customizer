...
function(deploy_mingw_runtime PROJECT_NAME)
    ...
    if(DLLS_TO_INSTALL)
        ...
        install(FILES ${DLLS_TO_INSTALL} DESTINATION ${CMAKE_INSTALL_BINDIR} COMPONENT Prerequisites)
...
function(deploy_boost_runtime)
    ...
    if(BOOST_DLLS_TO_INSTALL)
        ...
        install(FILES ${BOOST_DLLS_NORMALIZED} DESTINATION ${CMAKE_INSTALL_BINDIR} COMPONENT Prerequisites)
